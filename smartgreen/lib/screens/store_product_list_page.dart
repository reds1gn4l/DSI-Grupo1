...
class _ProductListPageState extends State<ProductListPage> {
  ...
  Future<void> _confirmDelete(StoreProduct p) async {
    final ok =
        await showDialog<bool>(
          ...
          builder:
              (_) => AlertDialog(
                ...
                content: Text('Deseja remover "${p.cientificName}"?'),
                actions: [
                  TextButton(
        ...
        false;
    if (ok) await _service.delete(p.id);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<StoreProduct>>(
        stream: _service.stream(search: _search),
        builder: (context, snap) {
                      ...
                      CustomButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const StoreProductFormPage(),
                            ),
                          );
                        },
                      ),
          ...
          return ListView.separated(
            ...
            itemCount: items.length + 1, // último item é o botão
                    ...
                    subtitle: Padding(
                      ...
                      child: Text(
                        [
                          ...
                          if (p.stock != null) 'Estoque: ${p.stock}',
                        ].join(' • '),
                      ),
                    ),
