                        ...
                        child:
                            (item.product.imageURL.isNotEmpty)
                                ? Image.network(
                                  ...
                                  fit: BoxFit.cover,
                                  errorBuilder:
                                      (_, __, ___) => _cartImagePlaceholder(),
                                )
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            // VALOR ATUAL (baseado no número de itens) - em verde
                            Text(
                              _money(
                                subtotal,
                              ), // Agora mostra o subtotal (preço * quantidade)
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  'Valor unitário:', // Mudado de 'Subtotal:' para 'Valor unitário:'
                                  style: theme.textTheme.bodySmall,
                                ),
                                Text(
                                  _money(
                                    price,
                                  ), // Agora mostra apenas o valor unitário
                                  style: theme.textTheme.bodySmall,
                                ),
                              ],
                            ),
    ...
    return Container(
      ...
      child: FittedBox(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const LeafGlyph(size: 40, color: Colors.green),
            const SizedBox(height: 4),
            const Text(
              'Imagem indisponível',
