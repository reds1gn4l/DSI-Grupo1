...
class CartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey.shade50, // mesmo fundo das demais
      appBar: AppBar(
      ...
      body: const SafeArea(
        top: false,
        child: CartContent(), // reaproveita o mesmo conteúdo
      ),
    );
  }
}

/// Conteúdo do carrinho sem Scaffold/AppBar, para uso dentro da HomePage.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Área inferior com total + ações (padrão visual, sem Scaffold)
        Container(
